...
```bash
# On node api-fra-1:
curl -X POST $STREAMS/v0/topics/chat:general \
...
curl -X PUT $STREAMS/v0/routers/fra-to-iad \
  -H 'content-type: application/json' \
...
curl -X PUT $STREAMS/v0/routers/iad-to-fra \
  -H 'content-type: application/json' \
...
curl -X POST $STREAMS/v0/topics/chat:general/diff \
  -H 'content-type: application/json' \
