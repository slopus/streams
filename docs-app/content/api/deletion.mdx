---
title: Deletion
description: Permanently remove records by seq range and/or tag match with POST /v0/topics/:topic/delete — permanent, immediate, silent, and point-in-time.
---
...
<div className="route"><span className="verb post">POST</span><span className="path">/v0/topics/:topic/delete</span></div>
...
- **Effective immediately** — invisible to all reads at once (diff, topic-state `count`/`bytes`,
...
```json
# → 200 OK
{ "topic": "jobs", "deleted": 1, "earliest_seq": 480001, "head_seq": 480234,
