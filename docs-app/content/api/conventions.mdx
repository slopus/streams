...
or tenant in the host — streams is single-machine. Examples across these docs use
`$STREAMS` for the base URL — set it with `export STREAMS=http://localhost:4000` (or your
server's address).
