---
title: Reading (diff)
description: Consume a topic from a seq cursor with POST /v0/topics/:topic/diff — the cursor is the ack, skipped records still advance, and involuntary loss surfaces as a tombstone.
---
...
<div className="route"><span className="verb post">POST</span><span className="path">/v0/topics/:topic/diff</span></div>
...
<Callout type="info">
  ...
  that, use a [queue topic](/api/queues) (`type:"queue"`) and the claim/ack/nack/extend
