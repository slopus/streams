...
| `reason` | `"cap"` (evicted for capacity), `"ttl"` (expired), `"mixed"` (both), or `"recreated"` (box was deleted then recreated). Best-effort/informational — the **range is authoritative**. |
