...
description: How streams schedules post-write delivery work — a banded weighted-fair queue over dirty topics with aging and recency-based priority — and how the elastic governor sheds latency under CPU pressure while never sacrificing correctness.
---
...
After a write commits, streams still has to *propagate* it — wake the topic's SSE watchers,
