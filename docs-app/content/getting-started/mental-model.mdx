...
streams has five concepts, and they are the whole product: a **Topic** is a named
...
durability, retention, and priority — almost every decision in streams is a per-topic
decision.
